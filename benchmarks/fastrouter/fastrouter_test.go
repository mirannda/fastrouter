...
func BenchmarkFastRouter_10000000Goroutines_26Prams(b *testing.B) {
	var group sync.WaitGroup
...
func BenchmarkFastRouter_10000000Goroutines_NoPrams(b *testing.B) {
	var group sync.WaitGroup
